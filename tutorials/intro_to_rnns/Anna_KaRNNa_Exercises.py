...
def build_lstm(lstm_size, num_layers, batch_size, keep_prob):
    ...
    # cell = tf.contrib.rnn.MultiRNNCell( [drop] * num_layers ) # tf 1.0
    cell = tf.contrib.rnn.MultiRNNCell( [make_cell(lstm_size) for _ in range(num_layers)] ) # tf 1.1
    initial_state = cell.zero_state(batch_size, tf.float32)
...
checkpoint = 'checkpoints/i60200_l128.ckpt'
...
checkpoint = 'checkpoints/i60600_l128.ckpt'
samp = sample(checkpoint, 1000, lstm_size, len(vocab), prime="Far")
print(samp)
...
checkpoint = 'checkpoints/i61200_l128.ckpt'
samp = sample(checkpoint, 1000, lstm_size, len(vocab), prime="Far")
print(samp)
